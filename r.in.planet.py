...
#            Vaclav Petras
#
# PURPOSE:   Download Planet data through the Planet API
#
# COPYRIGHT: (C) 2020 Corey White and the GRASS Development Team
#
...
#%module
#% description: Download Planet data through the Planet API
#% keyword: import
#% keyword: raster
#% keyword: Planet
#% keyword: Imagery
